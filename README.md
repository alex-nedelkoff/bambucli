...
register-*.ps1          Windows service / scheduled-task registration
start-uvicorn.cmd       Launches the app under the scheduled task
docs/                   Architecture, glossary, future-improvement notes
OPERATIONS.md           Operator runbook (Windows) — start here to run it
...
setup are covered in **[OPERATIONS.md](OPERATIONS.md)**.

---

## Documentation

- **[OPERATIONS.md](OPERATIONS.md)** — run it, restart it, fix it (Windows).
